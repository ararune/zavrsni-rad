...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('myapp', '0017_remove_korisnik_grad_remove_korisnik_zupanija'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oib', models.CharField(max_length=11, unique=True, validators=[django.core.validators.RegexValidator('^\\d{11}$', message='OIB must be exactly 11 digits')])),
